...
- `username`: รหัสประจำตัว (รหัสนักเรียน / รหัสครู) **หรือ** อีเมล ได้ทั้งสองแบบ
  - รหัสประจำตัวเทียบแบบตรงตัว (case-sensitive) เช่น `T00116`
  - อีเมลไม่สนตัวพิมพ์ใหญ่-เล็ก
  - ถ้าอีเมลนั้นซ้ำกันหลายคน จะถือว่า **ไม่ผ่าน** (`invalid_credentials`) เพื่อไม่ให้ล็อกอินสลับคน — ให้แอดมินแก้อีเมลซ้ำก่อน
