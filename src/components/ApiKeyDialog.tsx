          ...
          <div>
            ...
            {scopes.some((s) => WRITE_SCOPES.includes(s as ApiScope)) && (
              <div className="alert alert-error" style={{ marginTop: 10, fontSize: 13 }}>
                ...
                ขณะนี้มีอย่างเดียวคือช่อง &ldquo;เบอร์เพิ่มเติม&rdquo; ของนักเรียน — ช่องที่ธุรการไม่ได้กรอก
                ทำไว้เพื่อการนี้โดยเฉพาะ จึงแตะเบอร์ฉุกเฉิน ชื่อ ชั้น/ห้อง หรืออะไรก็ตามที่โรงเรียนกรอกเองไม่ได้เลย
                และทุกครั้งถูกบันทึกว่า key ไหนเขียนของใคร จากค่าอะไรเป็นค่าอะไร
              </div>
            )}
