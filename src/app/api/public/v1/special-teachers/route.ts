 ...
 *
 * Auth: `special-teachers:read`. There is no `:pii` or `:photo` twin because
 * the table holds neither — an อาจารย์พิเศษ has no login, no เลขบัตร ปชช. and
 * no photo in this module, so the roster line IS the whole record.
 *
